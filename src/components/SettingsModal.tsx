        ...
        >
          ...
          <div className="p-8 pb-4 flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <h2 className="font-serif text-2xl font-bold text-olive italic">Configuración</h2>
            </div>
            <button 
              onClick={onClose}
            ...
            <div className="space-y-8">
              <div className="space-y-3">
                <label className="flex items-center gap-2 text-[11px] font-bold uppercase tracking-[0.2em] text-muted-ink opacity-40 ml-1">
                  <Key className="w-3.5 h-3.5" /> Clave Secreta de Groq
                </label>
                <input 
                  type="password"
                  value={groqKey}
                ...
                />
                <p className="text-[10px] text-muted-ink/40 italic px-1">Lumen utiliza Groq por su velocidad y privacidad.</p>
              </div>

              <div className="space-y-3">
                <label className="flex items-center gap-2 text-[11px] font-bold uppercase tracking-[0.2em] text-muted-ink opacity-40 ml-1">
                  <Cpu className="w-3.5 h-3.5" /> Cerebro Digital
                </label>
                <select 
                  value={selectedModel}
